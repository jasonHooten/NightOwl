...
function NightOwl(services, storage, options){
...
require('util').inherits(NightOwl, events.EventEmitter);

/*---------------
 Ping service
-----------------*/
NightOwl.prototype.ping = function (params, callback){
...
/*-----------------------
 Starts the service
------------------------*/
NightOwl.prototype.start = function (){
 var self = this;
 ...
 console.log('NightOwl monitor started.');
};

/*-----------------------
 Stops the service
------------------------*/
NightOwl.prototype.stop = function (){
 this.daemon_status = 0;
 console.log('stopping NightOwl...');
};

module.exports = NightOwl;
